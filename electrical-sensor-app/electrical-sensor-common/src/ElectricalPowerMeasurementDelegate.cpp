...
CHIP_ERROR ElectricalPowerMeasurementDelegate::Read(const ConcreteReadAttributePath & aPath, AttributeValueEncoder & aEncoder)
{
...
CHIP_ERROR ElectricalPowerMeasurementDelegate::SetPowerMode(PowerModeEnum newValue)
{
    ...
    if (oldValue != newValue)
    {
        ...
        MatterReportingAttributeChangeCallback(this->Delegate::mEndpointId, ElectricalPowerMeasurement::Id, PowerMode::Id);
    }
                                                               ...
                                                               Structs::HarmonicMeasurementStruct::Type & harmonicCurrent)
{
     ...
     *  MatterReportingAttributeChangeCallback(this->Delegate::mEndpointId, ElectricalPowerMeasurement::Id, HarmonicCurrents::Id);
     */
                                                                        ...
                                                                        Structs::HarmonicMeasurementStruct::Type & harmonicPhase)
{
     ...
     *
     * The application should also ensure it notifies remote clients that the value has changed
     *  MatterReportingAttributeChangeCallback(this->Delegate::mEndpointId, ElectricalPowerMeasurement::Id, HarmonicPhases::Id);
     */
...
CHIP_ERROR ElectricalPowerMeasurementDelegate::SetVoltage(DataModel::Nullable<int64_t> newValue)
{
    ...
    if (oldValue != newValue)
    {
        ...
        MatterReportingAttributeChangeCallback(this->Delegate::mEndpointId, ElectricalPowerMeasurement::Id, Voltage::Id);
    }
...
CHIP_ERROR ElectricalPowerMeasurementDelegate::SetActiveCurrent(DataModel::Nullable<int64_t> newValue)
{
    ...
    {
        // We won't log raw values since these could change frequently
        MatterReportingAttributeChangeCallback(this->Delegate::mEndpointId, ElectricalPowerMeasurement::Id, ActiveCurrent::Id);
    }
...
CHIP_ERROR ElectricalPowerMeasurementDelegate::SetReactiveCurrent(DataModel::Nullable<int64_t> newValue)
{
    ...
    {
        // We won't log raw values since these could change frequently
        MatterReportingAttributeChangeCallback(this->Delegate::mEndpointId, ElectricalPowerMeasurement::Id, ReactiveCurrent::Id);
    }
...
CHIP_ERROR ElectricalPowerMeasurementDelegate::SetApparentCurrent(DataModel::Nullable<int64_t> newValue)
{
    ...
    {
        // We won't log raw values since these could change frequently
        MatterReportingAttributeChangeCallback(this->Delegate::mEndpointId, ElectricalPowerMeasurement::Id, ApparentCurrent::Id);
    }
...
CHIP_ERROR ElectricalPowerMeasurementDelegate::SetActivePower(DataModel::Nullable<int64_t> newValue)
{
    ...
    {
        // We won't log raw values since these could change frequently
        MatterReportingAttributeChangeCallback(this->Delegate::mEndpointId, ElectricalPowerMeasurement::Id, ActivePower::Id);
    }
...
CHIP_ERROR ElectricalPowerMeasurementDelegate::SetReactivePower(DataModel::Nullable<int64_t> newValue)
{
    ...
    {
        // We won't log raw values since these could change frequently
        MatterReportingAttributeChangeCallback(this->Delegate::mEndpointId, ElectricalPowerMeasurement::Id, ReactivePower::Id);
    }
...
CHIP_ERROR ElectricalPowerMeasurementDelegate::SetApparentPower(DataModel::Nullable<int64_t> newValue)
{
    ...
    {
        // We won't log raw values since these could change frequently
        MatterReportingAttributeChangeCallback(this->Delegate::mEndpointId, ElectricalPowerMeasurement::Id, ApparentPower::Id);
    }
...
CHIP_ERROR ElectricalPowerMeasurementDelegate::SetRMSVoltage(DataModel::Nullable<int64_t> newValue)
{
    ...
    {
        // We won't log raw values since these could change frequently
        MatterReportingAttributeChangeCallback(this->Delegate::mEndpointId, ElectricalPowerMeasurement::Id, RMSVoltage::Id);
    }
...
CHIP_ERROR ElectricalPowerMeasurementDelegate::SetRMSCurrent(DataModel::Nullable<int64_t> newValue)
{
    ...
    {
        // We won't log raw values since these could change frequently
        MatterReportingAttributeChangeCallback(this->Delegate::mEndpointId, ElectricalPowerMeasurement::Id, RMSCurrent::Id);
    }
...
CHIP_ERROR ElectricalPowerMeasurementDelegate::SetRMSPower(DataModel::Nullable<int64_t> newValue)
{
    ...
    {
        // We won't log raw values since these could change frequently
        MatterReportingAttributeChangeCallback(this->Delegate::mEndpointId, ElectricalPowerMeasurement::Id, RMSPower::Id);
    }
...
CHIP_ERROR ElectricalPowerMeasurementDelegate::SetFrequency(DataModel::Nullable<int64_t> newValue)
{
    ...
    {
        // We won't log raw values since these could change frequently
        MatterReportingAttributeChangeCallback(this->Delegate::mEndpointId, ElectricalPowerMeasurement::Id, Frequency::Id);
    }
...
CHIP_ERROR ElectricalPowerMeasurementDelegate::SetPowerFactor(DataModel::Nullable<int64_t> newValue)
{
    ...
    {
        // We won't log raw values since these could change frequently
        MatterReportingAttributeChangeCallback(this->Delegate::mEndpointId, ElectricalPowerMeasurement::Id, PowerFactor::Id);
    }
...
CHIP_ERROR ElectricalPowerMeasurementDelegate::SetNeutralCurrent(DataModel::Nullable<int64_t> newValue)
{
    ...
    {
        // We won't log raw values since these could change frequently
        MatterReportingAttributeChangeCallback(this->Delegate::mEndpointId, ElectricalPowerMeasurement::Id, NeutralCurrent::Id);
    }
