...
class ElectricalPowerMeasurementDelegate : public ElectricalPowerMeasurement::Delegate, public chip::app::AttributeAccessInterface
{
public:
    ElectricalPowerMeasurementDelegate() : AttributeAccessInterface(Optional<EndpointId>(), ElectricalPowerMeasurement::Id) 
     {
     ...
     */
    // Implementación de los métodos virtuales de AttributeAccessInterface
